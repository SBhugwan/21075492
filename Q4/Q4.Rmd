...
```{r Figure5,  warning =  FALSE, fig.align = 'center', fig.cap = "Common Stars on Netflix  \\label{Figure1}", fig.ext = 'png', fig.height = 3, fig.width = 6}
...
```{r Figure6,  warning =  FALSE, fig.align = 'center', fig.cap = "Correlation \\label{Figure3}", fig.ext = 'png', fig.height = 3, fig.width = 6}
...
```{r Figure7,  warning =  FALSE, fig.align = 'center', fig.cap = "Content Produced by Country \\label{Figure1}", fig.ext = 'png', fig.height = 3, fig.width = 6}
...
```{r Figure8,  warning =  FALSE, fig.align = 'center', fig.cap = "Word cloud most dominate genres \\label{Figure2}", fig.ext = 'png', fig.height = 3, fig.width = 6}
